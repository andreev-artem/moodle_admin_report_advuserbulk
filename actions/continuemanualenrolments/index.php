...
check_action_capabilities('continuemanualenrolments', true);
...
$pluginname = ACTIONS_LANG_PREFIX.'continuemanualenrolments';
...
$courseswithmanual = $DB->get_records(
        'enrol',
        array('enrol' => 'manual', 'status' => ENROL_INSTANCE_ENABLED),
        '',
        'courseid');
$availablecourses = array_intersect($availablecourses, array_keys($courseswithmanual));
